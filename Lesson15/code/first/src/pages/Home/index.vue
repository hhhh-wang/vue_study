<template>
  <div>
    ...
    <!--楼层-->
    <Floor v-for="item in $store.state.product.floorList" :floorInfo="item" :key="item.id"></Floor>
...
import TodayRecommend from "@/pages/Home/TodayRecomment/TodayRecomment.vue";
import Floor from "@/pages/Home/Floor/index.vue";
export default {
  name: "Home",
  components: {Floor, TodayRecommend, FocusAdv},
  mounted(){
