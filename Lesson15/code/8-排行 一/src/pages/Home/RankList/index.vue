    ...
    <div class="rank">
        <div class="tab">
            <div class="tab-tit clearfix">
                <a @click="activeIndex=index" v-for="(item,index) in rankList" :key="item.id"
                   href="javascript:;"
        ...
        <div v-show="activeIndex===index" class="content" v-for="(item,index) in rankList">
            <ul>
                <li>
...
export default {
    name: "RankList",
    computed:mapState("product",["rankList"]),
    data(){
        return {
            activeIndex:0
        }
