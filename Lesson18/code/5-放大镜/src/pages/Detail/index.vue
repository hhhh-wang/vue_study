                    ...
                    <div class="specScroll">
                        ...
                        <div class="items">
                            <div class="itemsCon" style="transition: all 0.5s ease 0s;">
                                ...
                                <img src="../../assets/images/s1.png"><img src="../../assets/images/s2.png"><img
                                    src="../../assets/images/s3.png"><img src="../../assets/images/s1.png"><img
                                    src="../../assets/images/s2.png"><img src="../../assets/images/s3.png"><img
                                    src="../../assets/images/s1.png"><img src="../../assets/images/s2.png"><img
                                    src="../../assets/images/s3.png"><img src="../../assets/images/s1.png"><img
                                    src="../../assets/images/s2.png"><img src="../../assets/images/s3.png"><img
                                    src="../../assets/images/s1.png"><img src="../../assets/images/s2.png"><img
                                    src="../../assets/images/s3.png"></div>
                        </div>
                        <!--右按钮-->
                        <a class="next">&gt;</a>
                    </div>
                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl v-for="item in spuSaleAttrList" :key="item.id">
                                ...
                                <dd :class="{active:info.isChecked/1===1}" v-for="info in item.spuSaleAttrValueList" :key="info.id" changepirce="0">{{info.saleAttrValueName}}</dd>
                            </dl>
                        </div>
