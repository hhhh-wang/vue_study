      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input @input="upBuyNum" autocomplete="off" :value="buyNum" value="1" class="itxt">
                <a href="###" class="plus" @click.prevent="changeBuyNum">+</a>
                <a href="###" class="mins" @click.prevent="changeBuyNum">-</a>
              </div>
              <div class="add">
                <a href="###" @click.prevent="addCart">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...mapMutations('product', ['UP_ATTR_LIST_BY_ID']),
    upAttr(a1Id,a2Id,isChecked){
      if (isChecked===1)  return;
      this.UP_ATTR_LIST_BY_ID({ a1Id, a2Id });
    },
    // 加入购物车
    async addCart() {
      console.log("你好老李",this.spuSaleAttrList);
